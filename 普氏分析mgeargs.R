#加载数据
micro <- read.csv("C:/Users/Robin.DESKTOP-0U5O684/Desktop/data/mgepro.csv", header=T, row.names=1)
args <- read.csv("C:/Users/Robin.DESKTOP-0U5O684/Desktop/data/argpro.csv", header=T, row.names=1)
#计算两个矩阵的距离
...
pro_test <- protest(pcoa_m, pcoa_a, perm = 9999)  #普氏分析组间数据的检验
